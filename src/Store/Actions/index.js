...
export const collectNotes = () => dispatch => {
    ...
    axios.get('https://hidden-bayou-18567.herokuapp.com/api/notes')
...
export const assembleNote = (note) => dispatch => {
    ...
    axios.post('https://hidden-bayou-18567.herokuapp.com/api/notes/', {...note})
...
export const reviseNote = (noteId, note) => dispatch => {
    ...
    axios.put(`https://hidden-bayou-18567.herokuapp.com/api/notes/${noteId}`, note)
...
export const expungeNote = noteId => dispatch => {
    ...
    axios.delete(`https://hidden-bayou-18567.herokuapp.com/api/notes/${noteId}`)
